...
CACHES = {
    'default': {
        ...
        'LOCATION': 'rediss://default:ZqK0Psq2YAwfIfWsdaMlRR35H6DzmmXb@redis-16038.c61.us-east-1-3.ec2.redns.redis-cloud.com:16038', 
        'OPTIONS': {
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'book_anon': '5/min',  # 5 requests per minute for unauthenticated users
        'book_user': '5/min',  # 5 requests per minute for authenticated users
    }
}
